...
<div class="content">
    <nav class="breadcrumb bg-white push">
        ...
        <a href="{{route('dosen.kelas.create')}}" class="breadcrumb-item active">Tambah Kelas</a>
    </nav>
</div>
@endsection
@section('main')
    ...
    <div class="block">
       <div class="block-header block-header-default">
          <div class="row">
            ...
            <div class="font-size-lg font-w600">&emsp;Tambah Kelas</div>
          </div>
       </div>

       <form action="{{route('dosen.kelas.store')}}" method="post" id="question_form">
            {{ csrf_field() }}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input autocomplete="off" type="text" class="form-control" id="input-name" name="lokasi">
                        </div>
                    </div>
                </div>
                <div class="row">
