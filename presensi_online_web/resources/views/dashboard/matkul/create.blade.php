...
<div class="content">
    <nav class="breadcrumb bg-white push">
        ...
        <a href="{{route('dosen.matkul.create')}}" class="breadcrumb-item active">Tambah Mata Kuliah</a>
    </nav>
</div>
@endsection
@section('main')
    ...
    <div class="block">
       <div class="block-header block-header-default">
          <div class="row">
            ...
            <div class="font-size-lg font-w600">&emsp;Tambah Mata Kuliah</div>
          </div>
       </div>

       <form action="{{route('dosen.matkul.store')}}" method="post" id="question_form">
            {{ csrf_field() }}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input required autocomplete="off" type="text" class="form-control" id="input-name" name="kode">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input required autocomplete="off" type="text" class="form-control" id="input-name" name="nama">
                        </div>
                    </div>
                </div>
                <div class="row">
