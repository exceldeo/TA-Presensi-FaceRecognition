...
<div class="content">
    <nav class="breadcrumb bg-white push">
        ...
        <a href="{{route('dosen.jadwal.mahasiswa.kehadiran.create', ['id' => $jadwal->id_jadwal])}}" class="breadcrumb-item active">Tambah Jadwal Kehadiran</a>
    </nav>
</div>
@endsection
@section('main')
    ...
    <div class="block">
       <div class="block-header block-header-default">
          <div class="row">
            ...
            <div class="font-size-lg font-w600">&emsp;Tambah Jadwal Kehadiran</div>
          </div>
       </div>

       <form action="{{route('dosen.jadwal.mahasiswa.kehadiran.store', ['id' => $jadwal->id_jadwal])}}" method="post" id="question_form">
            {{ csrf_field() }}
                ...
                <div class="form-row">
                    <div class="form-group col-lg-12">
                        ...
                        <div id="sandbox-container">
                            <input autocomplete="off" type="text" type="text" class="form-control" name="tanggal" id="tanggal" value="<?php echo date("m/d/Y") ?>"/>
                        </div>
                    </div>
                </div>
